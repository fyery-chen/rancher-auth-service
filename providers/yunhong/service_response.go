...
type AuthenticationResponse struct {
	...
	AuthenticationDate  string      // Time at which authentication was performed
...
func addRubycasAttribute(attributes UserAttributes, key, value string) {
	...
	default:
		...
		log.Warningf("cas: service response: unable to parse %v value: %#v (kind: %v)", key, decoded, kind)
	}
